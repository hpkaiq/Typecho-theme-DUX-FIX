...
<?php if ($this->options->indexpic == 'able'): ?>
                <a class="focus" href="<?php $this->permalink() ?>"><img referrerpolicy="no-referrer" src="<?php echo showThumb($this,null,true); ?>" data-src="<?php echo showThumb($this,null,true); ?>" class="thumb" ></a>
<?php endif; ?>
                <header>
