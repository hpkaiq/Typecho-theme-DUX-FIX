...
<?php if ($this->options->indexpic == 'able'): ?>
                    <a class="focus" href="<?php $this->permalink() ?>"><img src="<?php $this->options->themeUrl('img/thumbnail.png'); ?>" data-src="<?php echo showThumb($this,null,true); ?>" class="thumb" referrerpolicy="no-referrer"></a>
<?php endif; ?>
                    <header>
